...
@property (nonatomic, weak) IBOutlet UIPickerView * __null_unspecified typePicker;
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified ipField;
...
- (NSString * __nullable)convertToTextFromIndex:(NSInteger)row;
- (IBAction)Cancel:(id __nonnull)sender;
- (IBAction)doneClicked:(id __nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UISwitch * __null_unspecified cellSwtich;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified cellButton;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified TitleLabel;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified IPLabel;
@property (nonatomic, weak) IBOutlet UISlider * __null_unspecified rSlider;
@property (nonatomic, weak) IBOutlet UISlider * __null_unspecified gSlider;
@property (nonatomic, weak) IBOutlet UISlider * __null_unspecified bSlider;
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified rgbViewer;
@property (nonatomic) BOOL isObserving;
@property (nonatomic, strong) NSString * __nonnull mode;
@property (nonatomic, strong) NSDictionary * __nonnull selfInfo;
+ (CGFloat)expandedHeightLED;
+ (CGFloat)expandedHeight;
+ (CGFloat)defaultHeight;
@property (nonatomic, strong) NSTimer * __nonnull sliderTimer;
@property (nonatomic, strong) NSTimer * __nonnull disableShitTimer;
...
- (IBAction)likedThis:(UIButton * __nonnull)sender;
- (void)refreshContents;
- (void)updatedSlider;
- (void)sendRGBRefresh;
- (IBAction)updatedR:(id __nonnull)sender;
- (IBAction)updatedG:(id __nonnull)sender;
- (IBAction)updatedB:(id __nonnull)sender;
- (IBAction)switchToggle:(id __nonnull)sender;
...
@property (nonatomic, copy) NSDictionary<NSIndexPath *, NSNumber *> * __nonnull dictMap;
@property (nonatomic, strong) NSUserDefaults * __nonnull saved;
- (IBAction)handleCellTap:(UITapGestureRecognizer * __nonnull)recognizer;
